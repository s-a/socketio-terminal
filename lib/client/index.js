...
/**
 * @method .
 * @param {object} ncli - Instance of n-cli.
 * @example 
 ...
 * @param {function} done - event handler triggered when server was started. 
 */ 
 ...
 * @method connect 
 * @param {string} command - shell command to execute. 
 * @param {object} handlers - bundle of event handlers handlers {connect:onconnect, event:onevent, disconnect:ondisconnect}. 
 */ 
